...
$python preprocessing/get_codon_freq.py --input $refseq_tab --id $id --output $result_folder"/"$id"_step1_res.tsv"
...
$python preprocessing/get_couple.py --input $result_folder"/"$id"_step1_res.tsv" --output $result_folder"/"$id"_step2_res.tsv"
...
$python preprocessing/get_final_table.py --input $result_folder"/"$id"_step2_res.tsv" --output $result_folder"/"$id"_final.tsv"
...
echo ""
echo "Check your results in $result_folder"/ folder""
echo ""
